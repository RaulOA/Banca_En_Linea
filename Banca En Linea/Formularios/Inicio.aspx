                ...
                <div class="row justify-content-md-center align-items-center">
                    <div class="col-12 col-md-11 col-lg-9 col-xl-8 col-xxl-7">
                        ...
                        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                <asp:Button ID="btnRegistrarse" runat="server" Text="Registrarse" CssClass="btn bsb-btn-2xl btn-outline-light" PostBackUrl="~/Formularios/Login.aspx" />
                                <asp:Button ID="btnIniciarSesion" runat="server" Text="Iniciar Sesión" CssClass="btn bsb-btn-2xl btn-outline-light" PostBackUrl="~/Formularios/Login.aspx" />
                            </div>
                        </div>
                    </div>
                </div>
