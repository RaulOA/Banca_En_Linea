            ...
            <div class="row justify-content-md-center align-items-center">
                <div class="col-12 col-md-11 col-lg-9 col-xl-8 col-xxl-7">
                    ...
                    <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                        <button type="button" class="btn bsb-btn-2xl btn-outline-light" runat="server">Registrarse</button>
                        <button type="button" class="btn bsb-btn-2xl btn-outline-light" runat="server">Iniciar Sesión</button>
                    </div>
                </div>
            </div>
        </div>
