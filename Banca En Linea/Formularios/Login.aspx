...
<body>
    <form id="form1" runat="server">
        <div>
<section class="bg-light p-3 p-md-4 p-xl-5" runat="server">
    <div class="container" runat="server">
        <div class="row justify-content-center" runat="server">
            <div class="col-12 col-xxl-11" runat="server">
                <div class="card border-light-subtle shadow-sm" runat="server">
                    <div class="row g-0" runat="server">
                        <div class="col-12 col-md-6" runat="server">
                            <img src="<%= ResolveUrl("~/Images/pexels-dana-tentis-118658-370799.jpg") %>" alt="Welcome back you've been missed!" class="img-fluid rounded-start w-100 h-100 object-fit-cover" loading="lazy" runat="server" />
                        </div>
                        <div class="col-12 col-md-6 d-flex align-items-center justify-content-center" runat="server">
                            <div class="col-12 col-lg-11 col-xl-10" runat="server">
                                <div class="card-body p-3 p-md-4 p-xl-5" runat="server">
                                    <div class="row" runat="server">
                                        <div class="col-12" runat="server">
                                            <div class="mb-5" runat="server">
                                                <div class="text-center mb-4" runat="server">
                                                    <a href="#!" runat="server">
                                                        <img src="<%= ResolveUrl("~/Images/logo.png") %>" alt="" width="200" height="120" runat="server" />
                                                    </a>
                                                </div>
                                                <h4 class="text-center" runat="server">Welcome back you've been missed!</h4>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" runat="server">
                                        <div class="col-12" runat="server">
                                            <div class="d-flex gap-3 flex-column" runat="server">
                                                <a href="#!" class="btn btn-lg btn-outline-dark" runat="server">
                                            ...
                                            <p class="text-center mt-4 mb-5" runat="server">Or sign in with</p>
                                        </div>
                                    </div>
                                    <form action="#!" runat="server">
                                        <div class="row gy-3 overflow-hidden" runat="server">
                                            <div class="col-12" runat="server">
                                                <div class="form-floating mb-3" runat="server">
                                                    ...
                                                    <label for="email" class="form-label" runat="server">Email</label>
                                                </div>
                                            </div>
                                            <div class="col-12" runat="server">
                                                <div class="form-floating mb-3" runat="server">
                                                    ...
                                                    <label for="password" class="form-label" runat="server">Password</label>
                                                </div>
                                            </div>
                                            <div class="col-12" runat="server">
                                                <div class="form-check" runat="server">
                                                    <input class="form-check-input" type="checkbox" value="" name="remember_me" id="remember_me" runat="server">
                                                    <label class="form-check-label text-secondary" for="remember_me" runat="server">
                                                        Keep me logged in
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row" runat="server">
                                        <div class="col-12" runat="server">
                                            ...
                                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center mt-5" runat="server">
                                                <a href="#!" class="link-secondary text-decoration-none" runat="server">Create new account</a>
                                                <a href="#!" class="link-secondary text-decoration-none" runat="server">Forgot password</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <!-- Footer 12 - Bootstrap Brain Component -->
    <footer>

        <!-- Link & Icon - Bootstrap Brain Component -->
                ...
                <div class="row gy-3">
                    <div class="col-6 col-md-3">
                        <div class="link-wrapper">
                            ...
                            <ul class="m-0 list-unstyled">
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Overview
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Integrations
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Extensions
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Docs
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Projects
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Calendar
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="link-wrapper">
                            ...
                            <ul class="m-0 list-unstyled">
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Operations
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Marketing
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Bootstrap
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Products
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Finance
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Sales
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="link-wrapper">
                            ...
                            <ul class="m-0 list-unstyled">
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Events
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Demos
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Learning
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Webinars
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Customers
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Framer
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-6 col-md-3">
                        <div class="link-wrapper mb-3 mb-xl-4">
                            ...
                            <ul class="m-0 list-unstyled">
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">AI
                                    </a>
                                </li>
                                <li class="mb-1">
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Blog
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-underline-opacity-0 link-opacity-75-hover link-underline-opacity-100-hover link-offset-1 link-secondary">Wikis
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5">
                        <div class="link-wrapper">
                            <ul class="m-0 list-unstyled d-flex justify-content-md-end gap-2 gap-md-3">
                                <li>
                                    <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">Security
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">Privacy
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">Terms
                                    </a>
                                </li>
                                <li>
                                    <a href="#!" class="link-secondary text-decoration-none text-uppercase bsb-ls-1 fs-9 d-flex align-items-center">Settings
                                    </a>
                                </li>
                            </ul>
                        </div>
