                        ...
                        <div class="col-12 col-md-6 col-xl-7">
                            <div class="d-flex justify-content-center text-bg-primary">
                                <div class="col-12 col-xl-9">
                                    <img class="img-fluid rounded mb-4" loading="lazy" src="./assets/img/bsb-logo-light.svg" width="245" height="80" alt="Nuestro Logo Proximamente">
                                    <hr class="border-primary-subtle mb-4">
                                    <h2 class="h1 mb-4">Gestiona tu dinero de manera fácil y segura con EasyPay.</h2>
                                    <p class="lead mb-5">Con EasyPay puedes realizar pagos, transferencias y mucho más, desde cualquier lugar y en cualquier momento.</p>
                                    <div class="text-endx">
                            ...
                            <div class="card border-0 rounded-4">
                                <div class="card-body p-3 p-md-4 p-xl-5">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-4">
                                                <h3>Inicia sesión en tu cuenta de EasyPay</h3>
                                                <p>¿No tienes una cuenta? <a href="/Formularios/Register">Regístrate aquí</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <form action="#!">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <p class="mt-4 mb-4">O iniciar sesión desde:</p>
